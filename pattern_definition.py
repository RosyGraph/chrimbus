...
from challenges.c04_star import star
from challenges.c05_falling_snow import falling_snow
...
PATTERNS = {
    ...
    "trump_video": trump_video_pattern,
    "pacman_video": pacman_video_pattern,
